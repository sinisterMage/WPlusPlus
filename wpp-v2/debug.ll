...
@strlit_1 = private constant [6 x i8] c"AROOO\00"
...
entry:
  ...
  %call_Dog.bark = call i32 @Dog.Dog.bark()
  %call_Husky.bark = call i32 @Husky.Husky.bark()
  call void @wpp_thread_join_all()
  ret i32 0
}

define i32 @Dog.Dog.bark() {
entry:

...
@fmt_s.3 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@fmt_d = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

define i32 @wait() {
entry:
  %call_printf_str = call i32 (ptr, ...) @printf(ptr @fmt_s.2, ptr @strlit_1)
  ret i32 0
}
...
entry:
  ...
  %call_printf_str = call i32 (ptr, ...) @printf(ptr @fmt_s.3, ptr @strlit_2)
